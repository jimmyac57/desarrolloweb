...
const crearInputs = (id, id2,id3,id4,id5,id6) => {
    const html= `<label for=${id} ><em>Nombre del dispositivo:</em></label>
          <input type="text" id=${id} name="dispositivo[]" required><span></span><br><br>
...
document.getElementById('addDeviceBtn').addEventListener('click', () => {
    ...
    const nuevoDispositivoHTML = crearInputs(id, id2, id3, id4, id5,id6);
